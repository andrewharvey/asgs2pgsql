...
(
  ...
  "name" text,
  "ireg" asgs.ireg_code REFERENCES asgs_2011.ireg_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code)
);
...
(
  ...
  "name" text,
  "iare" asgs.iare_code REFERENCES asgs_2011.iare_csv(code),
  "ireg" asgs.ireg_code REFERENCES asgs_2011.ireg_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code)
);
...
(
  ...
  "name" text,
  "sos" asgs.sos_code REFERENCES asgs_2011.sos_csv(code)
);
...
(
  ...
  "name" text,
  "sosr" asgs.sosr_code REFERENCES asgs_2011.sosr_csv(code)
);
...
(
  ...
  "name" text,
  "gccsa" asgs.gccsa_code REFERENCES asgs_2011.gccsa_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code)
);
...
(
  ...
  "name" text,
  "sa4" asgs.sa4_code REFERENCES asgs_2011.sa4_csv(code),
  "gccsa" asgs.gccsa_code REFERENCES asgs_2011.gccsa_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code)
);
...
(
  ...
  "name" text,
  "sa3" asgs.sa3_code REFERENCES asgs_2011.sa3_csv(code),
  "sa4" asgs.sa4_code REFERENCES asgs_2011.sa4_csv(code),
  "gccsa" asgs.gccsa_code REFERENCES asgs_2011.gccsa_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code),
  "tr" asgs.tr_code REFERENCES asgs_2011.tr_csv(code),
  "sua" asgs.sua_code REFERENCES asgs_2011.sua_csv(code)
);
...
CREATE UNLOGGED TABLE asgs_2011.ra_csv
(
...
(
  ...
  "sa2" asgs.sa2_code REFERENCES asgs_2011.sa2_csv(code),
  "sa3" asgs.sa3_code REFERENCES asgs_2011.sa3_csv(code),
  "sa4" asgs.sa4_code REFERENCES asgs_2011.sa4_csv(code),
  "gccsa" asgs.gccsa_code REFERENCES asgs_2011.gccsa_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code),
  "iloc" asgs.iloc_code REFERENCES asgs_2011.iloc_csv(code),
  "poa" asgs.poa_code REFERENCES asgs_2011.poa_csv(code),
  "ssc" asgs.ssc_code REFERENCES asgs_2011.ssc_csv(code),
  "ced" asgs.ced_code REFERENCES asgs_2011.ced_csv(code),
  "sed" asgs.sed_code REFERENCES asgs_2011.sed_csv(code),
  "add" asgs.add_code REFERENCES asgs_2011.add_csv(code),
  "nrmr" asgs.nrmr_code REFERENCES asgs_2011.nrmr_csv(code),
  "ucl" asgs.ucl_code REFERENCES asgs_2011.ucl_csv(code),
  "ra" asgs.ra_code REFERENCES asgs_2011.ra_csv(code)
);
...
(
  ...
  "sa1" asgs.sa1_code REFERENCES asgs_2011.sa1_csv(code),
  "sa2" asgs.sa2_code REFERENCES asgs_2011.sa2_csv(code),
  "sa3" asgs.sa3_code REFERENCES asgs_2011.sa3_csv(code),
  "sa4" asgs.sa4_code REFERENCES asgs_2011.sa4_csv(code),
  "gccsa" asgs.gccsa_code REFERENCES asgs_2011.gccsa_csv(code),
  "ste" asgs.ste_code REFERENCES asgs_2011.ste_csv(code),
  "lga" asgs.lga_code REFERENCES asgs_2011.lga_csv(code)
);
