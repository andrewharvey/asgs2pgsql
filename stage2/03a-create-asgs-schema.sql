...
CREATE EXTENSION IF NOT EXISTS postgis SCHEMA asgs;
CREATE EXTENSION IF NOT EXISTS postgis SCHEMA asgs_2011;
CREATE EXTENSION IF NOT EXISTS postgis SCHEMA asgs_2015;
CREATE EXTENSION IF NOT EXISTS postgis SCHEMA asgs_2016;
